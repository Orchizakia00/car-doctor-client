    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex left-0 top-0 h-full items-center
                    ...
                    <div className='text-white space-y-7 w-1/2 pl-12'>
                        ...
                        <div>
                            <button className="btn bg-orange-600 border-none mr-5 text-white">Discover More</button>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute flex left-0 top-0 h-full items-center rounded-xl
                                bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='text-white space-y-7 w-1/2 pl-12'>
                        <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p>
